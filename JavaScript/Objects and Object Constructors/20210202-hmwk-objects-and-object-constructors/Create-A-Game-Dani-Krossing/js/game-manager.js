let GameManager = {
    ...
    resetPlayer: function (classType) {
        ...
        <img src="./images/${classType.toLowerCase()}.jpg" class="img-avatar">
        <div>
            <h3>${classType}</h3>
    ...
    setFight: function() {
        ...
        let enemy02 = new Enemy("Worm", 100, 0, 50, 100, 100);
        let enemy03 = new Enemy("Trojan", 200, 0, 150, 80, 150);
        ...
        getEnemy.innerHTML = `
        <img src="./images/${enemy.enemyType.toLowerCase()}.jpg" alt="${enemy.enemyType}" class="img-avatar">
        <div>
